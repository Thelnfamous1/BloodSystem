...
/***
 * Sourced from <a href="https://github.com/mekanism/Mekanism/blob/1.19.x/src/main/java/mekanism/common/util/VoxelShapeUtils.java">1.19.x Mekanism's VoxelShapeUtils</a>
 */
public class VoxelShapeUtils {

    private static final Vector3d FROM_ORIGIN = new Vector3d(-0.5, -0.5, -0.5);
